...
public class FavouriteOptionsDialog extends Dialog {

	public FlipImageView share, delete;

	public FavouriteOptionsDialog(SherlockFragmentActivity activity) {
		super(activity);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.favourite_options_dialog);
