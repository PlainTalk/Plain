...
public class Tribe extends TribeBase {
			...
			public void run() {
				...
				listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
					...
					public boolean onItemLongClick(AdapterView<?> arg0,
						...
						// TODO Auto-generated method stub
						socDialog = new StoryOptionsDialog(activity);
	...
	private void addLike(String jsonDocId, int currentLikes, String story,
			String tag, boolean admin, String username) {
		// TODO Auto-generated method stub
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case android.R.id.home:
			...
			break;
		case 1:
			edcDialog = new EditDataDialog(activity);
		...
		case 2:
			getSavedHashtags();
			tlcDialog = new TribeListDialog(activity);
