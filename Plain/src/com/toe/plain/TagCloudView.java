...
public class TagCloudView extends RelativeLayout {
	...
	public TagCloudView(Context mContext, int width, int height,
		...
		setBackgroundColor(Color.rgb(16, 139, 166));
		...
		mTagCloud = new TagCloud(Filter(tagList), (int) radius, textSizeMin,
				textSizeMax);
		float[] tempColor = { 1f, 1f, 1f, 1 };
		mTagCloud.setTagColor1(tempColor);// higher color
		mTagCloud.setTagColor2(tempColor);// lower color
	...
	View.OnClickListener OnTagClickListener(final String keyword) {
		return new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Toast.makeText(mContext, keyword, Toast.LENGTH_SHORT).show();
				Intent i = new Intent(mContext, ExploreSearchResults.class);
				Bundle b = new Bundle();
