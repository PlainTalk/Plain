...
public class Forums extends SherlockFragmentActivity {
	...
	private void getKeyword() {
		...
		if (hashtag == null) {
			...
			edcDialog.title = "What forum are you joining?";
			edcDialog.tag = "#";
			edcDialog.show();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		// TODO Auto-generated method stub
		getSupportMenuInflater().inflate(R.menu.forums_menu, menu);
		...
		case R.id.mNewPlain:
			if (hashtag == null) {
				...
				edcDialog.bDone.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						// TODO Auto-generated method stub
						publishStory(edcDialog.etDataField.getText().toString()
								.trim());
