...
/**
 * Custom implementation of android.app.Application.&nbsp;The android:name
 * attribute in the AndroidManifest.xml application element should be the name
 * of your class (".MyApp"). Android will always create an instance of the
 * application class and call onCreate before creating any other Activity,
